    ...
    <div className='w-full flex flex-col justify-center items-start mt-20 mb-5'>
        ...
        <div className='relative w-full'>
            ...
            <div className='relative bg-white w-1/3 h-96 m-5 rounded-2xl drop-shadow-md p-10'>
                    ...
                    <h1 className='text-slate-600 text-lg font-medium'>Description of the item</h1>
                    <div className='flex justify-between w-full'>
                        <p className='text-xl font-medium'><span className='text-red-500 text-base'>$</span>24.00</p>
                        <p className='text-xl text-slate-600 font-bold'><span className='text-yellow-300'>★</span>4.9</p>
                    </div>
