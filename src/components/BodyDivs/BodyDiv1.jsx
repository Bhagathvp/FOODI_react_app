    ...
    <div className='w-full flex justify-between items-center'>
      <div className='w-1/2 flex flex-col justify-center '>
        <div className='w-full m-5'>
            <h1 className='text-6xl font-extrabold'>Dive into Delights <br /> Of Delectable <span className='text-green-400'>Food</span></h1>
        </div>
        <p className='m-5 text-xl font-medium text-neutral-700'>Where Each Plate Weaves a Story of Culinary Mastery and Passionate Craftsmanship</p>
      ...
      <div className='w-1/2 h-full flex m-10'>
        <div className='realtive w-full'>
            ...
            <div className='absolute top-60 p-2 bg-slate-50 rounded-full drop-shadow-md'>
                <p className='text-lg text-red-500 font-semibold'>Hot spicy Food 🌶</p>
            </div>
            <div className='absolute -bottom-10 p-2 flex w-56 bg-slate-50 drop-shadow-md rounded-xl'>
                <div className='p-1'> 
                    <img src={delight1} alt="delight" className='w-16 h-16 rounded-xl'/>
                </div>
                <div className='p-1'>
                    <p className='font-medium'>Spicy noodles</p>
                    <p><span className='text-yellow-300'>★★★</span>☆☆</p>
                    <p className='font-medium'><span className='text-red-500 text-xs'>$</span>18.00</p>
                </div>

            </div>
            <div className='absolute right-60 -bottom-10 p-2 flex w-56 bg-slate-50 drop-shadow-md rounded-xl'>
                <div className='p-1'> 
                    <img src={delight2} alt="delight" className='w-16 h-16 rounded-xl'/>
                </div>
                <div className='p-1'>
                    <p className='font-medium'>Vegetarian salad</p>
                    <p><span className='text-yellow-300'>★★★★</span>☆</p>
                    <p className='font-medium'><span className='text-red-500 text-xs'>$</span>23.00</p>
                </div>
